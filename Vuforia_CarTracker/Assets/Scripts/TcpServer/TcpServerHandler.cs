...
public class TcpServerHandler : MonoBehaviour
{
    ...
    private void SendMessage()
    {
        ...
        try
        {
            ...
            if (stream.CanWrite)
            {
                PointCloudEncoder.Encode(stream);
    ...
    void Update()
    {
        PointCloudEncoder.cloud = new PointCloud(2);
        PointCloudEncoder.cloud.x[0] = 1f;
        PointCloudEncoder.cloud.y[0] = 2f;
        PointCloudEncoder.cloud.z[0] = 3f;
